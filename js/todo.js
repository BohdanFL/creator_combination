...
/**
 * *
 * * Пофіксити розміщення тексту гайду з деякими елементами
 * * Пофіксити: не закривається контекстне меню після переходу на наступну сторінку
 * * Закінчити добавляти елементи які будуть пояснюватись
 * * Добавити повноціний текст для гайдів 
 * * Оптимізувати і переробити систему створення гайдів
 * 
 * * Перейти на біліотеку draggable
 */
 ...
 * * undo - повертає список на одну дію назад
...
// // * * Переписати розміщення кнопок select-unselect - done
// // * * Гайд анімашками(показовий) - done
// // * * Добавити прикріплене меню зверху у ній мають бути - настройки, скарги і поради, тема, гайд
