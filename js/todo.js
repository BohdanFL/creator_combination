//` TODO: Global
/**
 * ! Можливості у самому choose - сортування, пошук, мультивибір, згрупованність по типам елементів - the next
...
/**
 * * * CHOOSE:
 * * 1)сортування - in reflections
 * * 2)пошук - done
 * * 3)мультивибір - done
 * * 4)згрупованність по типам елементів - done
 * * 5)красивий інтерфейс
 * 
